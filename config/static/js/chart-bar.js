window.addEventListener('load', function() {
    ...
    const externalTooltipHandler = (context) => {
        ...
        if (tooltip.opacity === 0) {
            ...
            tooltipEl.style.left = '-9999px'; // Прячем тултип за пределы видимости вместо удаления
            return;
        }
        ...
        if (tooltip.body) {
            ...
            // Header with month name and total sum (no color circle)
            ...
            const footerColorSpan = document.createElement('span');
            footerColorSpan.style.background = dataset.backgroundColor;
            footerColorSpan.style.borderRadius = '50%';
            footerColorSpan.style.display = 'inline-block';
            footerColorSpan.style.height = '10px';
            footerColorSpan.style.width = '10px';
            footerColorSpan.style.marginRight = '5px';

            footerTd.appendChild(footerColorSpan);
                ...
                datalabels: {
                    ...
                    formatter: (value, context) => {
                        if (value !== null && value !== undefined) {
                            ...
                            const labelWidth = context.chart.ctx.measureText(context.dataset.label).width;
